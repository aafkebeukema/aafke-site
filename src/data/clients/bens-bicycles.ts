...
export const bensBicycles: ClientLanding = {
  slug: 'bens-bicycles',
  service: 'automations',
  trade: 'mobile-bike-repair',
  clientName: "Ben's Bicycles",
  seoTitle: "A quick example for Ben's Bicycles | Aafke Beukema",
  description:
  ...
  eyebrow: "A quick example, just for Ben's Bicycles",
  ...
  steps: [
    ...
    {
      time: '3.43pm',
      note: "Ben copies it straight into Priya's chat. No typing from scratch, no awkward silence in the meantime.",
      demo: {
        type: 'draft',
        label: 'Ready to send to Priya',
        message:
          "Hi Priya, quick update from Ben, running a bit behind on today's jobs, should be with you in Nunhead by around 4.15 for the gears & brakes. Sorry about that!",
      },
    },
  ],
  callToAction: {
    heading: 'If this looks useful',
    body: "A few less stressful messages a day, every day, on top of never losing a booking that came in while you were halfway through a job. If this is worth five minutes to talk through for Ben's Bicycles specifically, I'd love to.",
